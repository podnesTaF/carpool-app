    ...
    <div className="flex flex-col gap-6 w-full px-4 mb-40">
      ...
      <div className="max-w-4xl w-full mx-auto">
        ...
        <div className="flex flex-col gap-5 py-6">
          ...
          {!carpool ? (
          ...
          ) : !carpool.passengerRides || carpool.passengerRides.length < 1 ? (
            ...
            carpool.passengerRides
              ...
              .map((p) => (
                <UserRideItem ride={p} key={p.id} hidePersonalInfo={!myRide} />
              ))
          )}
        </div>
        <div className="flex flex-col gap-3 py-6">
          ...
          {myRide && !myRide.driver && (
            <div className="flex flex-col sm:flex-row gap-4 justify-center sm:justify-start">
              <Link
                href={`https://www.google.com/maps?q=${carpool?.passengerRides?.[0]?.pickupLat},${carpool?.passengerRides?.[0]?.pickupLong}`}
                target="_blank"
              >
